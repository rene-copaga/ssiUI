...
export const EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    jobDescription: 'Debe garantizar que la experiencia del usuario al estar frente al producto de software sea lo mas agradable ' +
      'possible, cuidando que la usabilidad del producto sea maximizada, debe diseñar los flujos proponiendo nuevos procesos que  ' +
      'agilicen los actuales antes de la implementacion de las nuevas funcionalidades.'
  }
];
